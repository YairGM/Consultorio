...
$eda = strip_tags($edad); // Asi recogemos el nombre desde el formulario 
$n_ed = strlen($eda);

$peso = $_POST['peso'];            // Asi recogemos el email desde el formulario
$pes = strip_tags($peso); // Asi recogemos el nombre desde el formulario 
$n_pes = strlen($pes); 
...
$total_car = $n_receta * $n_paciente* $n_ap * $n_am * $n_ed * $n_pes * $n_aler * $n_consulta;    // Si alguno de ellos vale 0, $total_car valdrá 0 
